...
class Alien(Sprite):
    ...
    def __init__(self, ai_game):
        ...
        # Carga la imagen de la nave y establece su atributo rect.
...
# Esta clase Alien no necesita un método para dibujarla en la pantalla. En su lugar
# usaremos un método de grupo de Pygame que dibujará automáticamente los elementos del grupo
